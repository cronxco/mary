...
use Mary\View\Components\SparkEventIcon;
use Mary\View\Components\SparkEventObject;
use Mary\View\Components\SparkEventSummary;
use Mary\View\Components\SparkEventValue;
use Mary\View\Components\SparkObjectType;
use Mary\View\Components\SparkSpotlightValue;
use Mary\View\Components\SparkTag;
...
class MaryServiceProvider extends ServiceProvider
{
    ...
    public function registerComponents()
    {
        ...
        Blade::component($prefix . 'spark-event-icon', SparkEventIcon::class);
        Blade::component($prefix . 'spark-event-object', SparkEventObject::class);
        Blade::component($prefix . 'spark-event-value', SparkEventValue::class);
